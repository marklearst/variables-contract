...
description: "A strictly DTCG 2025.10 compliant variable file demonstrating primitive types, composite types, references, and group extension. This file uses only features defined in the DTCG 2025.10 specification. It does NOT use Variable Design Standard (VDS) extensions like modes in `$value`."
---
