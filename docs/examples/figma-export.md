...
This export format includes Figma-specific metadata and reference syntax. Use the [Figma Adapter](/variable-contract/adapters/figma) to normalize it into the canonical contract format defined in [Variable Contract](/variable-contract/contract/variable-contract).
...
See [Figma Adapter](/variable-contract/examples/adapters/figma) for complete normalization steps.
