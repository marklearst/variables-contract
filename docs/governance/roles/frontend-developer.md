...
- Test variable consumption (see [Consumption Tests](/variable-contract/testing/consumption-tests)).
...
See [Build Pipelines](/variable-contract/tooling/build-pipelines) for examples.
